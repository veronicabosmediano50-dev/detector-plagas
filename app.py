...
# ==========================================
# FUNCIÓN CENTRAL DE ANÁLISIS (Basada en tu código que funcionaba)
# ==========================================
def procesar_y_mostrar(image, col_resultado):
    """Procesa la imagen usando tu lógica original que ya funcionaba"""
    try:
        # Tu lógica original de conversión (la que funcionaba bien)
        if image.mode == 'RGBA':
            image = image.convert('RGB')
        elif image.mode == 'P':
            image = image.convert('RGB')
        elif image.mode != 'RGB':
            image = image.convert('RGB') # Fallback por seguridad
...
# ==========================================
# MODO 1: SUBIR IMAGEN (Tu código original intacto)
# ==========================================
    ...
    if uploaded_file:
        ...
        if st.button("🔍 Analizar Hoja"):
            with st.spinner("Analizando imagen..."):
                ...
                procesar_y_mostrar(image, col2)

# ==========================================
# MODO 2: CÁMARA EN VIVO (Usando la misma lógica segura)
# ==========================================
    ...
    if img_file_buffer is not None:
        ...
        with col2:
            # Usamos la EXACTA misma función que funcionaba en el Modo 1
            procesar_y_mostrar(image, col2)
